...
class LanguagesController extends AppController
{
    ...
    public function view($id = null)
    {
        $language = $this->Languages->get($id, [
            'contain' => ['AlternativeLanguages', 'Users']
        ]);
    ...
    public function add()
    {
        ...
        $alternativeLanguages = $this->Languages->AlternativeLanguages->find('list', ['limit' => 200]);
        $this->set(compact('language', 'alternativeLanguages'));
        $this->set('_serialize', ['language']);
    }
