...
/**
  ...
  * @var \App\Model\Entity\SubspacesMasterplan[]|\Cake\Collection\CollectionInterface $subspacesMasterplans
  */
?>
...
<div class="subspacesMasterplans index large-9 medium-8 columns content">
    <h3><?= __('Subspaces Masterplans') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($subspacesMasterplans as $subspacesMasterplan): ?>
            <tr>
