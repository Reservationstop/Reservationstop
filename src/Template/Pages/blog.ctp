	...
	<section>
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space pad-bot-redu-5" id="inner-page-title">
				...
				<div class="rows">
					<div class="posts">
						<div class="col-md-6 col-sm-6 col-xs-12"> <img src="../img/iplace-6.jpg" alt="" /> </div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							...
							<p>Randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p> <a href="#" class="link-btn">Read more</a> </div>
					</div>
					<div class="posts">
						<div class="col-md-6 col-sm-6 col-xs-12"> <img src="../img/iplace-2.jpg" alt="" /> </div>
						<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="posts">
						<div class="col-md-6 col-sm-6 col-xs-12"> <img src="../img/iplace-3.jpg" alt="" /> </div>
						<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="posts">
						<div class="col-md-6 col-sm-6 col-xs-12"> <img src="../img/iplace-4.jpg" alt="" /> </div>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<h3>Lorem ipsum dummy content</h3>
							<h5><span class="post_author">Author: Johnson</span><span class="post_date">Date: 12th May,2016</span><span class="post_city">City: Illunois</span></h5>
							<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</p>
