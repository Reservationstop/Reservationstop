						...
						<div class="tourz-hom-ser">
							<ul>
								<li>
									<?php
									echo $this->Html->link(
										$this->Html->image('icon/1.png') . ' ' . __('Hotel'),
										['controller'=> 'companies','action' => 'frontend'],
										array('escape' => false, 'class' => 'waves-effect waves-light btn-large tourz-pop-ser-btn'));
									?>
								...
								<li>
									<?php
									echo $this->Html->link(
										$this->Html->image('icon/2.png') . ' ' . __('Places'),
										['controller'=> 'pages','action' => 'display','places'],
										array('escape' => false, 'class' => 'waves-effect waves-light btn-large tourz-pop-ser-btn'));
									?>
								...
								<li>
									<?php
									echo $this->Html->link(
										$this->Html->image('icon/3.png') . ' ' . __('Booking'),
										['controller'=> 'pages','action' => 'display','booking'],
										array('escape' => false, 'class' => 'waves-effect waves-light btn-large tourz-pop-ser-btn'));
									?>
								</li>
								<li>
									<?php
									echo $this->Html->link(
										$this->Html->image('icon/4.png') . ' ' . __('Events'),
										['controller'=> 'pages','action' => 'display','events'],
										array('escape' => false, 'class' => 'waves-effect waves-light btn-large tourz-pop-ser-btn' ));
									?>
								</li>
							</ul>
