...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $companiesAreasMasterplan->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $companiesAreasMasterplan->id)]
            )
        ?></li>
...
<div class="companiesAreasMasterplans form large-9 medium-8 columns content">
    <?= $this->Form->create($companiesAreasMasterplan) ?>
    <fieldset>
        <legend><?= __('Edit Companies Areas Masterplan') ?></legend>
        <?php
